        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CivilianId = table.Column<string>(type: "nvarchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClerkUsersId = table.Column<int>(type: "int", nullable: true),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    CustomerUsersId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Users_ClerkUsersId",
                        column: x => x.ClerkUsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Users_CustomerUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Thumbnail = table.Column<string>(type: "nvarchar(200)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ClerkUsersId",
                table: "Orders",
                column: "ClerkUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_CustomerUsersId",
                table: "Orders",
